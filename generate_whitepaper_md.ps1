 # ============================================
# Generate Markdown Whitepaper (SP to dbt)
# ============================================

$repoDir = "C:\GIT\enterprise-sp-to-dbt-migration-framework"
$outputFile = Join-Path $repoDir "whitepaper\SP_to_DBT_Migration_Framework.md"
...
Write-Host "Markdown whitepaper generated at:"
